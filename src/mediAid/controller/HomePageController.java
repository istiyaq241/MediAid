...
public class HomePageController{
    ...
    public void goToReminder() {
        Main.setPreviousScene("/view/HomePage.fxml");
        Main.changeScene("/view/ReminderPage.fxml");
    }

    @FXML
    public void goToAddSituation() {
        Main.changeScene("/view/AddSituationForm.fxml");
    }

    @FXML
    public void goToVolunteer() {
        Main.changeScene("/view/VolunteerForm.fxml");
    }

    @FXML
    public void goToSeekHelp() {
        Main.changeScene("/view/SeekHelpPage.fxml");
    }

    @FXML
    public void goToAbout() {
        Main.changeScene("/view/About.fxml");
    }

    @FXML
    public void goToCredits() {
        Main.changeScene("/view/Credits.fxml");
    }
    ...
    public void goToDisease(ActionEvent actionEvent) {
        Main.changeScene("/view/DiseaseHelp.fxml");
    }

    public void goToAccident(ActionEvent actionEvent) {
